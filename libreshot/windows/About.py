...
#   Copyright (C) 2009  Jonathan Thomas  (http://launchpad.net/openshot/).
#
...
class frmAbout(SimpleGtkBuilderApp):
	...
	def __init__(self, path="About.ui", root="aboutdialog1", domain="LibreShot", version="0.0.0", project=None, **kwargs):
