...
class sequence:
	...
	def RenderRuler(self):
		...
		imgTrack_Track = gtk.image_new_from_file("%s/libreshot/themes/%s/Track_Middle.png" % (self.project.form.libreshot_path, theme))
		...
		# Load all 3 images
		imgTrack_Left = gtk.image_new_from_file("%s/libreshot/themes/%s/ruler_left.png" % (self.project.form.libreshot_path, theme))
		imgTrack_Middle = gtk.image_new_from_file("%s/libreshot/themes/%s/ruler_middle.png" % (self.project.form.libreshot_path, theme))
		imgTrack_Right = gtk.image_new_from_file("%s/libreshot/themes/%s/ruler_right.png" % (self.project.form.libreshot_path, theme))	   
		imgTrack_Tick = gtk.image_new_from_file("%s/libreshot/themes/%s/ruler_tick.png" % (self.project.form.libreshot_path, theme))	   
	...
	def RenderPlayHead(self):
		...
		# Load all 3 images
		imgTrack_PlayHead = gtk.image_new_from_file("%s/libreshot/themes/%s/play_head.png" % (self.project.form.libreshot_path, theme))
		imgTrack_Line = gtk.image_new_from_file("%s/libreshot/themes/%s/position_line.png" % (self.project.form.libreshot_path, theme))
		imgTrack_Ruler = gtk.image_new_from_file("%s/libreshot/themes/%s/ruler_right.png" % (self.project.form.libreshot_path, theme))
		imgTrack_Track = gtk.image_new_from_file("%s/libreshot/themes/%s/Track_Middle.png" % (self.project.form.libreshot_path, theme))
