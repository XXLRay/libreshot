...
########################################################################
class LibreShotFile:
	"""The generic file object for LibreShot"""
...
########################################################################
class LibreShotFolder:
	"""The generic folder object for LibreShot"""
	...
	def __init__(self, project=None):
		...
		# this list can contain LibreShotFolder or LibreShotFile objects
	...
	def file_exists_in_project(self, file_name):
		...
		for item in self.items:
			...
			if isinstance(item, LibreShotFile):
	...
	def FindFile(self, file_name):
		...
		reference to the LibreShot File that matches"""
		
		# loop through all files looking for the matching filename
		for file in self.items:
			if isinstance(file, LibreShotFile):
				name = file.name
	...
	def FindFolder(self, folder_name):
		"""Returns a reference to the LibreShotFolder
		 that matches the folder_name"""
		for folder in self.items:
			if isinstance(folder, LibreShotFolder):
				name = folder.name
	...
	def ListFolders(self):
		...
		folders = []
		for item in self.items:
			if isinstance(item, LibreShotFolder):
