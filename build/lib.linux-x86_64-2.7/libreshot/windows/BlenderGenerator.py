...
class frm3dGenerator(SimpleGtkBuilderApp):
	...
	def __init__(self, path="BlenderGenerator.ui", root="frm3dGenerator", domain="LibreShot", form=None, project=None, **kwargs):
		...
		# init blender tree
		self.OSTreeBlender = TreeBlender.LibreShotTree(self.treeTemplates, self.project)
	...
	def Render(self, frame=None):
		...
		# LibreShot to inject the user-entered params into the Python script.
