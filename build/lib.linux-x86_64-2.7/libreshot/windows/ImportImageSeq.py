...
class frmImportImageSequence(SimpleGtkBuilderApp):
	...
	def __init__(self, path="ImportImageSeq.ui", root="frmImportImageSequence", domain="LibreShot", form=None, project=None, pattern=None, initial_folder=None, **kwargs):
	...
	def on_btnImport1_clicked(self, widget, *args):
		...
		if not matches:
			...
			if number_of_matches <= 1:
				...
				# create LibreShotFile (and thumbnail) of the first match
