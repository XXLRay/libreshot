...
class frmImportTransitions(SimpleGtkBuilderApp):
	...
	def __init__(self, path="ImportTransitions.ui", root="frmImportTransitions", domain="LibreShot", form=None, project=None, **kwargs):
	...
	def import_transition(self):
		...
		try:
			...
			# copy transition & icon into .libreshot folder
